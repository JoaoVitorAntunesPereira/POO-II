import uuid
from conta import Transacao, Conta, TipoOperacao
from nicegui import ui, app, observables
from datetime import datetime
from rich import print
from conta_controller import *
import os
import pandas as pd 
...
c1 = Conta(10000, "joao@gmail.com", 5000, "JOao vitor", uuid.uuid4())
c2 = Conta(510, "jose@gmail.com", 100, "sjose", uuid.uuid4())
...
if os.path.exists('arquivos/contas.csv'):
    ...
    ContaController.criar_arquivo()

conta_controller.adicionar_conta_arquivo(c1)
conta_controller.adicionar_conta_arquivo(c2)
conta_controller.adicionar_conta_arquivo(c3)
...
def index():
    ...
    df = pd.read_csv("arquivos/contas.csv")
    df_filtrado = df[['nome', 'pix']]
    table.from_pandas(df_filtrado)
